#decompiled by PDM31
import os, sys
print '\x1b[1;32mUntuk ID dan Password Login bisa kalian lihat di https://docs.google.com/document/d/1r9kHB7HuxFiU0iNOcVeDB2xE_C2Xcv05KtGgMb9Tuf8/edit?usp=sharing '
print '\x1b[1;32mSilahkan Login '
import os, sys

def wa():
    os.system('xdg-open https://api.whatsapp.com/send?phone=+6285781147726&text=Assalamualaikum')
    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://www.iwancode.com/2024/06/script-hack-fb-termux-masal.html')
                time.sleep(2)
                menu()
